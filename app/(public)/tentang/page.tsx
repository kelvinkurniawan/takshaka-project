export const metadata = {
	title: "Tentang Kami - Takshaka CMS",
	description: "Pelajari lebih lanjut tentang Takshaka CMS dan misi kami",
};
			...
			<section className="bg-gradient-to-r from-primary to-blue-600 text-white py-16">
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					<p className="text-xl text-blue-50 mt-4">
						Pelajari kisah di balik Takshaka CMS
					</p>
				</div>
			</section>
			...
			<div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
				<section className="mb-16">
					...
					<p className="text-lg text-gray-700 leading-relaxed mb-4">
						Takshaka CMS adalah platform headless CMS modern yang dirancang
						untuk memenuhi kebutuhan manajemen konten digital di era modern.
						Kami percaya bahwa setiap bisnis, dari startup hingga enterprise,
						berhak memiliki akses ke teknologi CMS yang powerful namun mudah
						digunakan.
					</p>
				...
				<section className="bg-primary text-white rounded-lg p-12 text-center">
					...
					<p className="text-lg text-blue-50 mb-8">
						Hubungi kami untuk mengetahui bagaimana Takshaka CMS dapat membantu
						bisnis Anda
					</p>
					<a
						href="/hubungi"
