...
export const metadata = {
	title: "Hubungi Kami - Takshaka CMS",
	description: "Hubungi tim Takshaka CMS untuk pertanyaan dan dukungan",
};
					...
					<div className="lg:col-span-1">
						<div className="space-y-8">
							...
							<div>
								...
								<a
									href="mailto:hello@Takshaka CMS.com"
									className="text-primary hover:underline"
								>
									hello@Takshaka CMS.com
								</a>
							</div>
